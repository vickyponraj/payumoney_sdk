...
//                        com.payu.payuui.Activity.PaymentsActivity.this.finish();
                        Intent intent = new Intent();
                        intent.putExtra("result", "onBackApprove");
                        intent.putExtra("payu_response", "onBackApprove");
                        setResult(Activity.RESULT_CANCELED, intent);
                        finish();
                    }
...
/*                    @Override
               ...
               // customBrowserConfig.setSurepayS2Surl("");
                 ...
                 * */
                customBrowserConfig.setMerchantCheckoutActivityPath("com.kishorp18.android.payumoney_sdk.payu.MerchantCheckoutActivity");
